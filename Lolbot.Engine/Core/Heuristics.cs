...
public static class PieceSquareTables
{
    ...
    public static readonly int[] OpeningTables = [
        ..mg_pawn_table.Reverse(),
        ..mg_knight_table.Reverse(),
        ..mg_bishop_table.Reverse(),
        ..mg_rook_table.Reverse(),
        ..mg_queen_table.Reverse(),
        ..mg_king_table.Reverse(),
    ];

    public static readonly int[] EndgameTables = [
        ..eg_pawn_table.Reverse(),
        ..eg_knight_table.Reverse(),
        ..eg_bishop_table.Reverse(),
        ..eg_rook_table.Reverse(),
        ..eg_queen_table.Reverse(),
        ..eg_king_table.Reverse(),
    ];
