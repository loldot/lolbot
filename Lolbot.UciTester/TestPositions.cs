...
public class TestPosition
{
    ...
    public string? ExpectedBestMove { get; set; }
    public string? ExpectedBestMoveUci { get; set; } // UCI notation version
    public string? WorstMove { get; set; } // For positions where we want to avoid certain moves
